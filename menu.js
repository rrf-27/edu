...
var presBtn = document.getElementById("pres-btn");
var presDisplay = document.getElementById("pres");
presBtn.onclick = () => {
    presDisplay.style.display = "flex";
}
...
function close(i)
{
    var el = xBtn[i].parentNode;
    xBtn[i].onclick = () => {
        el.style.animation = "offPopup 0.3s ease forwards";
        setTimeout(() => {
            el.style.display = "none";
            el.style.animation = "popup 0.3s ease forwards";
        }, 200);
    }
}
